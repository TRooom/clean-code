...
\__ Двойное подчеркивание также экранируется

\\ _Слеш также экранируеттся_
...
Подчерки внутри текста или цифр __это__текст  _3_3 не считаются выделением и должны оставаться символами подчерка.

Символы__подчеркивания__между текстом считаются обычными подчеркиваниями.

__только открывающие _символы не считаются выделением и выглядят как обычные символы.
